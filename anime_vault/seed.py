...
CATALOG_SEED: list[dict[str, Any]] = [
    ...
    },
    {
        "slug": "gintama",
        "title": "银魂",
        "subtitle": "外星人入侵江户后的无厘头热血群像",
        "release_info": "2006-2018 · Sunrise / BN Pictures",
        "studio": "Sunrise / BN Pictures",
        "synopsis": (
            "在天人来袭、武士衰落的架空江户，经营万事屋的坂田银时与志村新八、神乐"
            "一起接下各种委托。作品以恶搞、吐槽和日常闹剧展开，同时也在关键篇章中"
            "描写伙伴情义、武士信念与时代动荡下的战斗与抉择。"
        ),
        "cast": [
            "坂田银时 / 杉田智和",
            "志村新八 / 阪口大助",
        ...
        "poster_path": "poster/银魂.webp",
        "still_path": "Stills/银魂.webp",
        "sources": [
            {"label": "银魂 官方角色（万事屋）", "url": "https://www.tv-tokyo.co.jp/anime/gintama/chara/yorozu/"},
            {"label": "银魂 官方角色（攘夷派）", "url": "https://www.tv-tokyo.co.jp/anime/gintama/chara/jyoui/index.html"},
            {"label": "银魂 官方角色（真选组）", "url": "https://www.tv-tokyo.co.jp/anime/gintama/chara/shinsen/index.html"},
            {"label": "银魂 官方音乐信息与Staff", "url": "https://www.tv-tokyo.co.jp/anime/gintama/staff/"},
            {"label": "Wikipedia", "url": "https://en.wikipedia.org/wiki/Gintama"},
        ],
    },
]
